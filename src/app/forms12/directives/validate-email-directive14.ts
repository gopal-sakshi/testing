...
function validateEmail14FactoryFn(emailBlackListService44:EmailBlackList12Service) {
    return (c:FormControl) => {
        console.log("c ===> ", c);
        let isValid = emailBlackListService44.isValidEmail(c.value);
    ...
    providers: [
        {
            ...
            useFactory: (emailBlackListService44) => {              
              return validateEmail14FactoryFn(emailBlackListService44)
            },
