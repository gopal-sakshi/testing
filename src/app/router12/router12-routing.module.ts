...
// All the routes listed below are child routes of      "localhost:9999/router-12"
const routes: Routes = [
  { path: '', component: HomeRouter12Component },
  { path: 'params12',  component: Params12Component },
  { path: 'snapshot12', component: Snapshot12Component },
