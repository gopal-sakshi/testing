...
import { ControlValueAccessor, FormBuilder, FormControl, FormGroup, FormGroupDirective, NG_VALIDATORS, NG_VALUE_ACCESSOR, Validators } from '@angular/forms';
import { of } from 'rxjs';
...
export class ReusableFormComponent implements OnInit, ControlValueAccessor {
    ...
    writeValue(obj: any): void {
        const emtptyForm = { firstName: null, lastName: null, email: null };
